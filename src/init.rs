  ...
  "agents": [
    {
      ...
      "env": [
        {"type": "file",   "name": "ANTHROPIC_API_KEY", "path": "~/.secrets/anthropic"},
        {"type": "env",    "name": "OPENAI_API_KEY",   "var":  "OPENAI_API_KEY"},
        {"type": "source", "path": "~/.zshrc.d/zclaude.env"}
      ]
    },
    { "id": "gemini-backup", "cli": "gemini", "tier": "fallback" }
  ]
}
